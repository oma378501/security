...
class Sesion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('start_sesion, user_id_user', 'required'),
			array('user_id_user', 'numerical', 'integerOnly'=>true),
			array('end_sesion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_sesion, start_sesion, end_sesion, user_id_user', 'safe', 'on'=>'search'),
		);
	}
