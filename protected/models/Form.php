...
class Form extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name_form, url_form', 'required'),
			array('name_form', 'length', 'max'=>45),
			array('url_form', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_form, name_form, url_form', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'rolForms' => array(self::HAS_MANY, 'RolForm', 'form_id_form'),
		);
	}
